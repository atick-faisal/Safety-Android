...
fun IntroScreen4(
    ...
    if (!view.isInEditMode) {
        ...
        SideEffect {
            currentWindow?.let { window ->
                window.statusBarColor = Color(0xFFC2C2C2).toArgb()
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.intro_page_4_header),
        ...
        Column(
            ...
            Text(
                text = "Press on the Alarm button to seek immediate help from any of your contacts list",
                fontSize = 24.sp,
                color = Color.Black,
                lineHeight = 32.sp
            )
            ...
            Text(
                text = "اضغط على زر الإنذار لطلب المساعدة الفورية من أي شخص في قائمة جهات الاتصال الخاصة بك",
                fontSize = 28.sp,
                color = Color.Black,
                lineHeight = 36.sp,
